        ...
        <div class="lg:pt-[88px] pt-20 9xl:px-[245px] 7xl:px-[135px] 5xl:px-[67px] px-5 pb-28 overflow-auto main-content flex flex-col flex-1 font-Figtree bg-color-F6 dark:bg-[#292929] border-s dark:border-[#474746] border-color-DF">
            ...
            <div class="bg-white dark:bg-[#474746] p-3 rounded-xl flex items-center justify-start mb-6 gap-2.5">
                ...
                <p class="text-color-14 dark:text-white font-Figtree font-normal">
                    {!! __('Credits Balance: :x analyses left', ['x' => "<span id='seo-credit-remaining' class='font-semibold text-orange-500'>" . ($seoLimit == -1 ? __('Unlimited') : ($seoRemaining < 0 ? 0 : $seoRemaining)) . "</span>"]) !!}
                </p>
            </div>
            @endif
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.seo_remaining !== undefined) {
                    const creditElement = document.getElementById('seo-credit-remaining');
                    if (creditElement) {
                        creditElement.textContent = data.seo_remaining < 0 ? 0 : data.seo_remaining;
                    }
                }
