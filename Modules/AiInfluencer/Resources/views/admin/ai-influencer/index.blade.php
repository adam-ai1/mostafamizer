...
@section('page_title', __('Ai Influencer'))
...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="persona-list-container">
    <div class="card">
        <div class="card-header bb-none pb-0 mb-2">
            <h5>{{ __('Ai Influencer') }}</h5>
        ...
        <x-backend.datatable.filter-panel class="mx-1">
            ...
            <div class="col-md-3">
                <select class="select2-hide-search filter" name="features">
...
<script type="text/javascript">
    'use strict';
    var listContainer = "short-list-container";
    var endRoute = "/ai-shorts/";
</script>
