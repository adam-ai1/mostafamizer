...
class AiProductPhotographyExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    {
        return Archive::with('metas', 'imageCreator')->where('type', 'productshot_variant')->get();
    }
