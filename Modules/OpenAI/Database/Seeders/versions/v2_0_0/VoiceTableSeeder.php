...
class VoiceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-US-Standard-E')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-US-Standard-F')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Aria Serene',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-US-Standard-G')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Nova Celeste',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-US-Standard-I')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Thorne Archer',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-US-Standard-J')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Atlas Steele',
