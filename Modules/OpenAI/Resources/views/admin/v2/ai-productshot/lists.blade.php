...
@section('page_title', __('Ai Product Photography'))
...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="productshot-v2-list-container">
    <div class="card">
        <div class="card-header bb-none pb-0 mb-2">
            <h5>{{ __('Ai Product Photography') }}</h5>
...
<script type="text/javascript">
    ...
    var listContainer = "productshot-v2-list-container";
    var endRoute = "/ai-product-photography/";
</script>
