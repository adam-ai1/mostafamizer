...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\VoiceoverController@pdf', $prms) ? '1' : '0' }}";
    var csv = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\VoiceoverController@csv', $prms) ? '1' : '0' }}";
    var listContainer = "text-to-speech-list-container";
