...
<div class="border-b dark:border-[#474746] dark:bg-[#292929] bg-white 9xl:px-[185px] 7xl:px-[140px] sm:px-5 whitespace-nowrap w-full ">
    <div class="flex overflow-auto">
        @if($adminTemplateAccess && customerPanelAccess('template') || isset($currentPackage))
        ...
        <!-- Long Article -->
        @if( ($adminLongArticleAccess && customerPanelAccess('long_article')) || isset($currentPackage))
        ...
        @if( ($adminCodeAccess && customerPanelAccess('code')) || isset($currentPackage))
        ...
        @if( ($adminSpeechToTextAccess && customerPanelAccess('speech_to_text')) || isset($currentPackage))
        ...
        @if( ($adminTextToSpeechAccess && customerPanelAccess('voiceover')) || isset($currentPackage))
        ...
        @if( ($adminVoiceCloneAccess && customerPanelAccess('voice_clone')) || isset($currentPackage))
            <a href="{{ route('user.voiceClone.index') }}">
                <div class="relative {{ $menu == 'voice-clone' ? 'active-border text-color-14 dark:text-white' : 'text-color-89' }} flex gap-2.5 items-center px-5 py-[14px]">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <!-- Microphone Base -->
                        <g fill="currentColor">
                          <rect x="8" y="4" width="4" height="10" rx="2" />
                          <rect x="9" y="14" width="2" height="2" rx="1" />
                          <rect x="7" y="16" width="6" height="1" rx="0.5" />
                        </g>
                    ...
                    <p class="text-color-14 dark:text-white text-15 font-FigTree font-medium">{{ __('Voice Clone') }}</p>
                </div>
            </a>
        @endif
    </div>
