...
<div class="dark:bg-[#292929] bg-[#F6F3F2] sidebar-scrollbar overflow-auto flex flex-col flex-1 font-Figtree border-l dark:border-[#474746] border-color-DF h-screen relative">
    ...
    <div class="8xl:px-[185px] 7xl:px-[144px] px-5 pt-5 9xl:pb-[22px] pb-28">
        <div class="flex justify-end items-center mt-2.5 mb-5 gap-3">
            <a href="{{ route('user.voicoverTemplate') }}" class="justify-end items-center gap-2 text-color-14 dark:text-white inline-block text-right">
                            ...
                            @forelse ($audios as $audio)
                                    ...
                                    <td class="text-14 font-Figtree py-[18px] text-color-14 dark:text-white font-medium 3xl:pl-[34px] md:pr-6 px-3">
                                        <a href="{{ route('user.voiceoverView', ['id' => techEncrypt($audio->id)]) }}"
                                            ...
                                            md:w-full min-[850px]:w-[160px] lg:w-[350px] xl:w-[250px] 5xl:w-[300px] break-words flex items-center">
                                                {!! trimWords($audio->title, 85) !!}
                                            </span>
                                        </a>
                                        <span class="text-[13px] font-Figtree text-color-89 font-medium mt-2 lg:hidden block break-words">{{ ucfirst($audio->provider) }}</span>
                                        ...
                                        <span class="text-[13px] font-Figtree text-color-89 font-medium mt-2 sm:hidden block break-words">{{ $audio->generation_options['voice'] . ' ' . '(' . $audio->generation_options['gender'] . ')' }}</span>
                                    </td>
                                       ...
                                       <div class="flex justify-end gap-4 items-center lg:w-[290px]">
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="absolute ltr:right-0 rtl:left-0 mt-2 w-[201px] border border-color-89 dark:border-color-47 rounded-lg bg-white dark:bg-[#333332] z-50 table-drop-body dropdown-shadow">
                                                    <div class="my-2">
                                                        <a href="{{ route('user.voiceoverView', ['id' => techEncrypt($audio->id)]) }}" class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 dark:hover:bg-[#3A3A39] rounded-t-lg text-left">
                                                            <span class="w-4 h-4">
                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        <a
                                        class="magic-bg w-max rounded-xl text-16 text-white font-semibold py-3 px-6 mx-auto flex text-center my-10 cursor-pointer" href="{{ route('user.voicoverTemplate') }}">
                                            <span>
                                                {{ __('Generate Voice') }}
                                            </span>
                                        </a>
