...
class LongArticleDataProcessor
{
    ...
    private $defaultModel = "sonar-pro";
    ...
    {
        return [
            'model' => data_get($this->data, 'model', $this->defaultModel),
            "messages" => [
                [
                    "role" => "user",
            ...
            "max_tokens" => maxToken('longarticle_perplexity'),
            "top_p" => data_get($this->data['options'], 'top_p', 1),
            "presence_penalty" => data_get($this->data['options'], 'presence_penalty', 1),
            "frequency_penalty" => data_get($this->data['options'], 'frequency_penalty', 1),
        ];
    }
