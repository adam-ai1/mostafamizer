...
@section('page_title', __('Marketing Bot Dashboard'))
                ...
                <div class="max-w-[1280px] mx-auto px-5 pt-[21px] sm:pt-6 pb-[56px]">
                        ...
                        <div class="flex items-center gap-4">
                            <div>
                                ...
                                <p class="text-color-89 text-sm font-medium wrap-anywhere mt-1">
                                    {{ __('Welcome back! Here\'s your marketing overview') }}
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <a href="{{ route('user.marketing-bot.campaigns.index', ['orderBy' => 'newest']) }}"
                                class="rounded-[6px] text-[15px] text-center bg-color-14 hover:shadow-lg text-white px-5 py-2.5 font-medium hover:opacity-90 transition-all duration-200"
                            >
                                {{ __('See Campaigns') }}
                            </a>
                            <a href="{{ route('user.marketing-bot.campaigns.whatsapp-campaign.create') }}"
                    ...
                    >
                        ...
                        <div class="kpi-cards-content hidden rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10">
                                ...
                                <div
                                    class="text-3xl lg:text-4xl font-bold mt-2 text-gradient-1"
                                >
                                    {{ $data['active'] ?? 0 }}
                                </div>
                        </div>
                        <div class="kpi-cards-content hidden rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10">
                                ...
                                <div
                                    class="text-3xl lg:text-4xl font-bold mt-2 text-gradient-1"
                                >
                                    {{ $data['campaignCounts']['scheduled'] ?? 0 }}
                                </div>
                        </div>
                        <div class="kpi-cards-content hidden rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10">
                                <div class="flex items-center justify-between mb-4">
                                ...
                                <div
                                    class="text-3xl lg:text-4xl font-bold mt-2 text-gradient-1"
                                >
                                    {{ $data['campaignCounts']['published'] ?? 0 }}
                                </div>
                        </div>
                        <div class="kpi-cards-content hidden rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10">
                                <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="text-sm text-color-89 font-medium">{{ __('Contacts') }}</div>
                                <div
                                    class="text-3xl lg:text-4xl font-bold mt-2 text-gradient-1"
                                >
                    ...
                    <!-- Start Charts Row -->
                    <section class="grid grid-cols-1 5xl:grid-cols-3 gap-6 mb-8" id="charts-row-section">
                        <!-- Charts Skeleton -->
                        <div class="charts-skeleton xl:col-span-2 rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 animate-pulse">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="h-10 w-32 bg-gray-200 dark:bg-gray-700 rounded-xl"></div>
                            </div>
                            <div class="h-80 bg-gray-200 dark:bg-gray-700 rounded"></div>
                        </div>

                        <div class="charts-skeleton rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 animate-pulse">
                            <div class="mb-6">
                        ...
                        <!-- Actual Charts (Hidden initially) -->
                        <div class="charts-content xl:col-span-2 rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 hidden">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <h2 class="text-color-14 dark:text-white font-bold text-xl">
                                        {{ __('Campaign Performance') }}
                                    </h2>
                                    <p class="text-color-89 text-sm mt-1">
                                        {{ __('Track your campaign success across channels') }}
                                    </p>
                                </div>
                                <select
                                    id="rangeSelect"
                                    class="text-sm rounded-xl border border-light-secondary/20 dark:border-dark-secondary/20 px-4 py-2 bg-light-card dark:bg-dark-card focus:ring-2 focus:ring-purple-400 transition-all duration-200"
                                >
                            ...
                            <div id="campaignLine" class="mt-4"></div>
                        </div>

                        <div class="charts-content rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 hidden">
                            <div class="mb-6">
                                <h2 class="text-color-14 dark:text-white font-bold text-xl">
                            ...
                            <div id="channelDonut" class="mt-4"></div>
                        </div>
                    </section>
                    <!-- End Charts Row -->

                    <!-- Start Second Charts Row -->
                    <section class="grid grid-cols-1 5xl:grid-cols-3 gap-6 mb-8" id="second-charts-row-section">
                        <!-- Second Charts Skeleton -->
                        <div class="second-charts-skeleton xl:col-span-2 rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 animate-pulse">
                            <div class="mb-6">
                        ...
                        <div class="second-charts-skeleton rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 animate-pulse">
                            <div class="mb-6">
                        ...
                        <!-- Actual Second Charts (Hidden initially) -->
                        <div class="second-charts-content xl:col-span-2 rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 hidden">
                            <div class="mb-6">
                                <h2 class="text-color-14 dark:text-white font-bold text-xl">
                                    {{ __('Contact Growth') }}
                                </h2>
                                <p class="text-color-89 text-sm mt-1">
                                    {{ __('Monthly contact acquisition trends') }}
                                </p>
                            </div>
                            <div id="contactsArea" class="mt-4"></div>
                        </div>

                        <div class="second-charts-content rounded-xl bg-white dark:bg-color-3A p-6 border border-color-89/10 hidden">
                            <div class="mb-6">
                                <h2 class="text-color-14 dark:text-white font-bold text-xl">
                                    {{ __('Conversions') }}
                                </h2>
                                <p class="text-color-89 text-sm mt-1">
                                    {{ __('This month\'s performance') }}
                                </p>
                            </div>
                            <div id="conversionBar" class="mt-4"></div>
                        </div>
                    </section>
                    <!-- Start Second Charts Row -->
                    ...
                    <section
                        ...
                        id="campaigns-table-section"
                    >
                        <!-- Table Skeleton -->
                        <div class="table-skeleton animate-pulse">
                            <div class="flex items-center justify-between p-6 border-b border-color-89/10">
                                <div>
                                    <div class="h-6 w-40 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
                                    <div class="h-4 w-64 bg-gray-200 dark:bg-gray-700 rounded"></div>
                                </div>
                                ...
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody class="bg-white dark:bg-color-3A divide-y divide-light-secondary/10 dark:divide-dark-secondary/10">
                                        ...
                                        <tr class="border-t border-color-89/10">
                                            ...
                                            <td class="px-6 py-5">
                                                <div class="h-6 w-20 bg-gray-200 dark:bg-gray-700 rounded-xl"></div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                            ...
                                            <td class="px-6 py-5 text-center">
                                                <div class="h-10 w-10 bg-gray-200 dark:bg-gray-700 rounded-xl mx-auto"></div>
                                            </td>
                                        </tr>
                                        @endfor
                                    </tbody>
                        ...
                        <div class="table-content hidden">
                            <div
                                class="flex items-center justify-between p-6 border-b border-color-89/10"
                            >
                                <div>
                                    <h2 class="text-color-14 dark:text-white font-bold text-xl">
                                        {{ __('Recent Campaigns') }}
                                    ...
                                    <p class="text-color-89 text-sm mt-1">
                                        {{ __('Manage your latest marketing efforts with precision') }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full text-sm">
                                    ...
                                    @forelse($data['recentCampaigns'] ?? [] as $campaign)
                                        <tr id="campaign-row-{{ $campaign->id }}"
                                            ...
                                            <td class="px-6 py-5">
                                                <div
                                                    class="id-badge text-color-14 dark:text-white text-xs font-bold px-3 py-2 rounded-lg inline-flex items-center justify-center min-w-[60px]"
                                                >
                                                    #{{ $loop->index + 1 }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="h-3 w-3 bg-yellow-400 rounded-full animate-pulse"
                                                    ></div>
                                                    <span
                                        ...
                                        <td class="px-6 py-5">
                                            ...
                                            @else
                                                <span class="border border-white/10 backdrop-sepia-50 w-fit flex items-center rounded-xl bg-gray-100 dark:bg-gray-900/30 text-gray-700 dark:text-gray-400 px-3 py-1.5 text-xs font-semibold">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-4 w-4 me-1.5">
                                        ...
                                        <td class="px-6 py-5">
                                            <div class="text-color-89 font-medium">
                                                @if ( isset($campaign->schedule_date) && isset($campaign->schedule_time) )
                                                    {{ $campaign->schedule_date }} at {{ $campaign->schedule_time }}
                                                @elseif ( isset($campaign->schedule_date) )
                                        ...
                                        <td class="px-6 py-5 text-center">
                                            <button
                                                data-target="modal2" data-id="{{ $campaign->id }}"
                                                aria-label="{{ __('Delete campaign') }}"
                                                class="openModalBtn mx-auto hover:scale-105 p-3 h-10 w-10 rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white flex items-center justify-center hover:from-red-600 hover:to-red-700 shadow-sm hover:shadow-red-200 dark:hover:shadow-red-900/50 transition duration-200 ease-in-out"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    fill="none"
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            ...
                                            <p class="text-center font-medium text-color-89 text-15 px-5 py-3 font-Figtree mt-3 md:w-[450px] mx-auto">{{ __('Looks like you did not create any data yet.')}}</p>
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
                                ...
                                <div
                                    ...
                                    <div class="px-7">
                                        ...
                                        <div class="flex justify-center gap-3 mt-6">
                                            <button
                                                    class="delete-campaign w-full flex items-center justify-center rounded-[6px] text-sm text-center magic-bg hover:shadow-lg text-white px-5 py-2.5 font-medium hover:opacity-90 transition-all duration-200"
                                            >
                                                <span>{{ __('Delete') }}</span>
...
@section('js')
    <script src="{{ asset('Modules/MarketingBot/Resources/assets/js/apexcharts.min.js') }}?v={{ config('artifism.version', '1.0.0') }}"></script>
    <script src="{{ asset('Modules/MarketingBot/Resources/assets/js/dashboard.min.js') }}?v={{ config('artifism.version', '1.0.0') }}"></script>
