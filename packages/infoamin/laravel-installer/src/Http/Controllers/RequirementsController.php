...
class RequirementsController extends Controller
{
    ...
    public function requirements()
    {
        ...
        $outputBufferInfo = $this->requirements->checkOutputBuffer(config('installer.core.output_buffering'));
        $requirements   = $this->requirements->check(config('installer.requirements'));
        return view('packages.installer.requirements', compact('requirements', 'phpSupportInfo', 'outputBufferInfo'));
    }
}
