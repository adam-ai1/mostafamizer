<div class="h-max bg-white dark:bg-color-14 rounded-[30px] card-border h-[20vh] mt-[100px]">
    <div class="rounded-[30px] border h-[354px] border-color-89 h-[256px] dark:border-color-47 bg-white dark:bg-color-14 6xl:py-9 py-8 6xl:px-11 lg:px-5 px-8 text-[#763CD4]">
        ...
        <div class="flex text-[#DF2F2F] bg-[#DF2F2F26] text-[#FF0000] bg-[#FF000026] flex-col gap-[18px] h-[132px] ltr:3xl:pr-[34px] ltr:pr-3 rtl:3xl:pl-[34px] mt-8 h-[304px] top-[54px] -right-[15px] md:-right-[18px]">
        ...
        <div class="flex flex-col text-[#FCCA19] gap-[18px] !bg-[#D6C5EB] dark:border-b-color-3A bottom-4 mt-8 !bg-blue-200 2xl:w-[450px] h-[428px] lg:w-[350px] 5xl:w-[640px]">
