...
use Modules\Subscription\Entities\{
 ...
 class PackageService
 {
    ...
    public static function features(): array
    {
        ...
        return [
            ...
            "video" => [
                ...
                "is_value_fixed" => 0,
                "title" => "Video Limit",
                "description" => __("Video description will be here"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            ...
            "voice-clone" => [
                ...
                "value" => "1",
                "is_value_fixed" => 0,
                "title" => "Voice Clone Limit",
                "description" => __("Voice Clone description will be here"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "seo-analysis" => [
                ...
                "value" => "10",
                "is_value_fixed" => 0,
                "title" => "SEO Analysis Limit",
                "description" => __("Number of SEO website analyses allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "presentation" => [
                ...
                "description" => __("Number of AI presentations allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "image_resizer" => [
                ...
                "value" => "20",
                "is_value_fixed" => 0,
                "title" => __("Image Resizer Limit"),
                "description" => __("Number of multi-size image generations allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "podcast" => [
                ...
                "value" => "10",
                "is_value_fixed" => 0,
                "title" => __("Podcast Limit"),
                "description" => __("Number of AI podcasts allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "audio_ads" => [
                ...
                "value" => "20",
                "is_value_fixed" => 0,
                "title" => __("Audio Ads Limit"),
                "description" => __("Number of AI audio advertisements allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
            "voxchat" => [
                ...
                "value" => "100",
                "is_value_fixed" => 0,
                "title" => __("VoxChat Messages"),
                "description" => __("Number of VoxChat messages allowed"),
                "title_position" => "before",
                "is_visible" => 1,
                "usage" => 0,
            ],
     ...
     * @return array
     */
    public static function supportedFeature(Package $package) : array{
        $featureMeta = $package->metaData()
            ->where('feature', '')
            ->where('key', 'featureAccess')
            ->first();
        
        if (!$featureMeta || !$featureMeta->value) {
            return [];
        }
        
        $formatFeature = json_decode($featureMeta->value, true) ?? [];
        
        $formattedNames = [];
        foreach ($formatFeature as $key => $value) {
            if ($value === '1') {
                $formattedNames[] = str_replace('_', ' ', ucwords($key));
            }
        }
