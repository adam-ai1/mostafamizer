...
use Modules\OpenAI\Http\Controllers\Admin\{
    ...
    ImportController,
    CodeController,
    PodcastAdminController,
    AudioAdsAdminController,
    VoxChatAdminController
};
...
//template
Route::middleware(['web', 'middleware' => 'userPermission:template'])->group(function () {
...
Route::prefix('user')->middleware(['auth', 'locale', 'web'])->name('user.')->group(function () {
    //template
    Route::middleware(['middleware' => 'userPermission:template'])->group(function () {
    ...
    // Text To Speech
    Route::middleware(['middleware' => 'userPermission:text_to_speech'])->group(function () {
    ...
    // Image
    Route::group(['prefix' => 'images', 'as' => 'image.', 'middleware' => 'userPermission:image', 'controller' => V2ImageController::class], function() {
    ...
    // Image To Video
    Route::group(['prefix' => 'image-to-video', 'as' => 'image-to-video.', 'middleware' => ['userPermission:video', 'teamAccess:video'], 'controller' => \Modules\OpenAI\Http\Controllers\Customer\v2\ImageToVideoController::class], function() {
    ...
    // Text To Video
    Route::group(['prefix' => 'text-to-video', 'as' => 'text-to-video.', 'middleware' => ['userPermission:text_to_video', 'teamAccess:video'],  'controller' => \Modules\OpenAI\Http\Controllers\Customer\v2\TextToVideoController::class], function() {
    ...
    // Gallery
    Route::group(['prefix' => 'gallery', 'as' => 'gallery.', 'middleware' => 'userPermission:image', 'controller' => GalleryController::class], function() {
    ...
    // AI Detector
    Route::get('ai-detector', [AiDetectorController::class, 'template'])->name('aiDetectorTemplate')->middleware('teamAccess:ai_detector', 'userPermission:ai_detector');

    // Plagiarism
    Route::get('plagiarism', [PlagiarismController::class, 'template'])->name('plagiarismTemplate')->middleware('teamAccess:plagiarism', 'userPermission:plagiarism');

    // Code
    Route::middleware(['middleware' => 'userPermission:code'])->group(function () {
    ...
    // Speech To Text
    Route::middleware(['middleware' => 'userPermission:speech_to_text'])->group(function () {
    ...
    // AI Duo Podcast
    Route::group(['prefix' => 'podcast', 'as' => 'podcast.', 'controller' => \Modules\OpenAI\Http\Controllers\Customer\PodcastController::class], function () {
        Route::get('/', 'index')->name('index');
        ...
        Route::get('/script/{id}', 'getScript')->name('script');
    });

    // AI Audio Ads - Professional Audio Advertisements
    Route::group(['prefix' => 'audio-ads', 'as' => 'audio-ads.', 'controller' => \Modules\OpenAI\Http\Controllers\Customer\AudioAdController::class], function () {
        Route::get('/', 'index')->name('index');
        Route::get('/create', 'create')->name('create');
        Route::post('/store', 'store')->name('store');
        Route::get('/show/{id}', 'show')->name('show');
    ...
    // Long Article
    Route::group(['prefix' => 'articles', 'as' => 'long_article.', 'controller' => LongArticleController::class, 'middleware' => 'userPermission:long_article'], function () {
        // Crud routes
    ...
    Route::group(['name' => 'voiceClone.', 'prefix' => 'voice-clone','as' => 'voiceClone.', 'controller' => VoiceCloneController::class, 'middleware' => ['teamAccess:voice_clone', 'userPermission:voice_clone']], function () {
        Route::get('/', 'template')->name('template');
    ...
    // Ai Persona
    Route::group(['as' => 'ai-persona.', 'prefix' => 'ai-persona', 'controller' =>  \Modules\OpenAI\Http\Controllers\Customer\v2\AiPersonaController::class, 'middleware' => ['userPermission:ai_persona']], function () {
     ...
     // Ai Avatar
    Route::group(['as' => 'ai-avatar.', 'prefix' => 'ai-avatar', 'controller' =>  \Modules\OpenAI\Http\Controllers\Customer\v2\AiAvatarController::class, 'middleware' => ['userPermission:ai_avatar']], function () {
        Route::get('/', 'template')->name('template')->middleware(['teamAccess:video']);
        Route::post('/store', 'store')->name('store')->middleware(['checkForDemoMode', 'teamAccess:video,api']);
    });

    Route::group(['as' => 'ai-product-photography.', 'prefix' => 'ai-product-photography', 'controller' =>  \Modules\OpenAI\Http\Controllers\Customer\v2\AiProductPhotographyController::class, 'middleware' => ['userPermission:ai_product_photography']], function () {
...
Route::middleware(['auth', 'locale', 'web'])->prefix('admin')->group(function () {
    ...
    Route::name('admin.features.')->group(function () {
        ...
        // Podcasts
        Route::get('podcasts', [PodcastAdminController::class, 'index'])->name('podcast.lists');
        Route::get('podcast/view/{id}', [PodcastAdminController::class, 'show'])->name('podcast.view');
        Route::delete('podcast/delete/{id}', [PodcastAdminController::class, 'delete'])->middleware(['checkForDemoMode'])->name('podcast.delete');
        Route::post('podcast/bulk-delete', [PodcastAdminController::class, 'bulkDelete'])->middleware(['checkForDemoMode'])->name('podcast.bulk-delete');

        // Audio Ads
        Route::get('audio-ads', [AudioAdsAdminController::class, 'index'])->name('audio-ads.lists');
        Route::get('audio-ads/view/{id}', [AudioAdsAdminController::class, 'show'])->name('audio-ads.view');
        Route::delete('audio-ads/delete/{id}', [AudioAdsAdminController::class, 'delete'])->middleware(['checkForDemoMode'])->name('audio-ads.delete');
        Route::post('audio-ads/bulk-delete', [AudioAdsAdminController::class, 'bulkDelete'])->middleware(['checkForDemoMode'])->name('audio-ads.bulk-delete');

        // VoxChat Conversations
        Route::get('voxchat', [VoxChatAdminController::class, 'index'])->name('voxchat.lists');
        Route::get('voxchat/view/{id}', [VoxChatAdminController::class, 'show'])->name('voxchat.view');
        Route::delete('voxchat/delete/{id}', [VoxChatAdminController::class, 'delete'])->middleware(['checkForDemoMode'])->name('voxchat.delete');
        Route::post('voxchat/bulk-delete', [VoxChatAdminController::class, 'bulkDelete'])->middleware(['checkForDemoMode'])->name('voxchat.bulk-delete');
...
Route::group(['prefix' => 'api', 'middleware' => ['api']], function () {
    ...
    Route::group(['as' => 'api.', 'prefix' => '/v2', 'middleware' => ['auth:api', 'locale', 'permission-api']], function () {
        ...
        // Chat Widget Bot
        Route::group(['as' => 'chatbotwidget.', 'prefix' => 'widget/chatbots', 'controller' => ChatBotWidgetController::class, 'middleware' => ['teamAccess:chatbot,api', 'userPermission:aichatbot']], function() {
            Route::get('/', 'index')->name('index');
        ...
        Route::group([
            ...
            'middleware' => ['teamAccess:chatbot,api', 'userPermission:aichatbot']
        ], function() {
         ...
         Route::group(['as' => 'chatbots.', 'prefix' => '/user/chatbots', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\ChatBotUserConversationController::class, 'middleware' => ['teamAccess:chatbot,api', 'userPermission:aichatbot']], function () {
         ...
         Route::group(['as' => 'chatbots.', 'prefix' => '/test/user/chatbots', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\ChatBotUserTestConversationController::class,'middleware' => ['teamAccess:chatbot,api', 'userPermission:aichatbot']], function () {
        ...
        Route::group(['as' => 'chat.', 'prefix' => 'chats', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\AiChatController::class], function () {
            ...
            Route::post('/', 'store')->name('store')->middleware('userPermission:chat', 'teamAccess:chat,api');
        });

        // Doc Chat
        Route::group(['as' => 'embed.','prefix' => 'embed-resources', 'controller' => AiDocChatController::class, 'middleware' => ['teamAccess:chat,api', 'userPermission:chat']], function () {
            Route::get('/', 'index')->name('index');
            Route::post('/', 'store')->name('store');
            Route::delete('{id}', 'delete')->name('delete');
        });

        Route::group(['as' => 'embed.', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\DocChatAskController::class, 'middleware' => ['teamAccess:chat,api', 'userPermission:chat']], function () {
        ...
        // Theme
        Route::group(['as' => 'theme.', 'controller' => UserAccessControllerAPI::class], function () {
            Route::get('theme', 'getTheme')->name('get');
            Route::post('theme/toggle', 'toggle')->name('toggle');
        });
        ...
        Route::group(['as' => 'voiceover.', 'prefix' => 'voiceover', 'controller' => VoiceoverControllerAPI::class], function () {
            ...
            Route::post('/', [VoiceoverControllerAPI::class, 'generate'])->middleware(['checkForDemoMode','userPermission:text_to_speech', 'teamAccess:voiceover,api']);
        ...
        Route::group(['as' => 'speech.', 'prefix' => 'speeches', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\SpeechToTextController::class], function () {
            Route::get('/', 'index')->name('index');
            Route::post('/', 'generate')->name('speechToText')->middleware(['checkForDemoMode', 'userPermission:speech_to_text', 'teamAccess:speech_to_text,api']);
            Route::get('{id}', 'show')->name('show');
        ...
        // Image
        Route::group(['as' => 'image.', 'prefix' => 'images', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\ImageController::class, 'middleware' => ['teamAccess:image,api', 'userPermission:image']], function () {
            Route::post('/', 'store')->name('store')->middleware(['checkForDemoMode']);
        ...
        // Voice Clone
        Route::group(['as' => 'voiceClone.', 'name' => 'voiceClone.' , 'prefix' => 'voice-clone', 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\VoiceCloneController::class, 'middleware' => ['teamAccess:voice_clone,api', 'userPermission:voice_clone']], function () {
        ...
        // Text To Video
        Route::group(['as' => 'text-to-video.', 'prefix' => 'text-to-video', 'middleware' => ['teamAccess:video,api', 'userPermission:text_to_video'], 'controller' => \Modules\OpenAI\Http\Controllers\Api\v2\User\TextToVideoController::class], function () {
            Route::post('/', 'generate')->name('store')->middleware(['checkForDemoMode']);
            Route::get('get-video/{id}', 'getVideo')->name('getVideo');
        });

        // Image To Video
        Route::group(['as' => 'aiVideo.', 'prefix' => 'image-to-video', 'controller' => ImageToVideoControllerAPI::class, 'middleware' => ['teamAccess:video,api', 'userPermission:video']], function () {
            Route::post('/', 'store')->name('store')->middleware(['checkForDemoMode']);
            Route::get('get-video/{id}', 'getVideo')->name('getVideo');
        });
