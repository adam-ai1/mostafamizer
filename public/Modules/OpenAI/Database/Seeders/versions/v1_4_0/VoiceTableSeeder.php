...
class VoiceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-GB-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'en-GB-Standard-B')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'bn-IN-Standard-A')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Anika Sen',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'bn-IN-Standard-B')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Aarav Dasgupta',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'fr-CA-Standard-A')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'fr-CA-Standard-B')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Jean Martin',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'yue-HK-Standard-A')->first();
        if(!$dbPreference) {
            $voiceId = DB::table('voices')->insertGetId([
                'name' => 'Li Wei',
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'yue-HK-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'ar-XA-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'ar-XA-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'bg-BG-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'ca-ES-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'nl-NL-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'nl-NL-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'ru-RU-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'ru-RU-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'es-ES-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'es-ES-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'pt-BR-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'pt-BR-Standard-B')->first();
       ...
       $dbPreference = \DB::table('voices')->where('voice_name', 'pl-PL-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'pl-PL-Standard-B')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'de-DE-Standard-A')->first();
        ...
        $dbPreference = \DB::table('voices')->where('voice_name', 'de-DE-Standard-B')->first();
