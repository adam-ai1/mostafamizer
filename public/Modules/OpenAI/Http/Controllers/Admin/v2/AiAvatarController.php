...
use Modules\OpenAI\DataTables\AiAvatarDataTable;
...
class AiAvatarController extends Controller
{
     ...
     *
     * @param AiAvatarDataTable $dataTable
     * @return Renderable
     */
    public function index(AiAvatarDataTable $dataTable)
    {
        $data['users'] = User::get();
    ...
    public function destroy($id)
    {
        ...
        $video = Archive::where('id', $id)->where('type', 'ai_avatar')->first();
