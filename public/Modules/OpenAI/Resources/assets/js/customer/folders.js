...
$(document).ready(function () {
    ...
    function updateSelectAllCheckbox() {
        ...
        if (allSelected) {
            ...
            selectedCountDisplay.textContent = jsLang('All files selected');
        } else {
    ...
    function updateSelectedCountDisplay() {
        ...
        if (selectedCount > 0) {
            ...
            selectedCountDisplay.textContent = selectedCount + ' ' + jsLang('selected:');
        } else {
            sopBoxes.forEach(box => {
    ...
    $(document).on('click', "#multiple-drive-modal", function (e) {
        ...
        $('.move-content-title').text(jsLang('Move') + ' ' + '"' + selectedCount + ' ' + jsLang('items') + '"');
