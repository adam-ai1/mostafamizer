        ...
        <div
            ...
            <div class="grow xl:px-0 px-5 xl:pt-[74px] pt-0 9xl:pb-[46px] pb-24 xl:w-1/2">
                <div class="xl:mt-4 ltr:xl:mr-12 rtl:xl:ml-12">
                    ...
                    <div id="text-to-video-gallery">
                        <section class="hidden break-inside-avoid mx-auto w-full max-w-sm rounded-3xl border border-white/10 bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] px-6 py-6 text-center shadow-2xl backdrop-blur-xl antialiased">

                            <!-- Icon -->
                            <div class="mx-auto mb-6 grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-500">
                                <div class="translate-x-1 border-y-[10px] border-y-transparent border-l-[18px] border-l-white"></div>
                            </div>

                            <!-- Title -->
                            <h1 class="mb-1 text-2xl font-semibold bg-gradient-to-br from-white to-fuchsia-400 bg-clip-text text-transparent animate-pulse">
                                {{ __('Generating Your Video') }}
                            </h1>

                            <!-- Subtitle -->
                            <p class="mb-4 text-sm leading-relaxed text-white/70">
                                {{ __('Creating something amazing for you. This may take a few moments.') }}
                            </p>
                            <div>
