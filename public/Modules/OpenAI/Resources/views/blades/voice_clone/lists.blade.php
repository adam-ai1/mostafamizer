...
@section('page_title', __('Voice Clone Lists'))
...
<div class="dark:bg-[#292929] bg-[#F6F3F2] sidebar-scrollbar overflow-auto flex flex-col flex-1 font-Figtree border-l dark:border-[#474746] border-color-DF h-screen relative">
    @include('openai::blades.history-nav', ['menu' => 'voice-clone'])
    <div class="8xl:px-[185px] 7xl:px-[144px] px-5 pt-5 9xl:pb-[22px] pb-28">
        <div class="flex justify-end items-center mt-2.5 mb-5 gap-3">
            <a href="{{ route('user.voiceClone.template') }}" class="justify-end items-center gap-2 text-color-14 dark:text-white inline-block text-right">
                ...
                <span class="text-[15px] leading-[22px] font-Figtree font-normal text-right">{{ __('Clone your Voice')}}</span>
            </a>
        </div>
                            ...
                            @forelse ($audios as $audio)
                                <tr class="border-b dark:border-[#474746]" id="voice_{{ $audio->id }}">
                                    <td class="text-14 font-Figtree py-[18px] text-color-14 dark:text-white font-medium 3xl:pl-[34px] md:pr-6 px-3">
                                       <img class="w-[40px] h-[40px] object-cover rounded-md" src="{{ $audio->fileUrl() }}" alt="{{ __('Image') }}">
                                        <span class="text-[13px] font-Figtree text-color-89 font-medium mt-2 lg:hidden block break-words">{{ ucfirst($audio->providers) }}</span>
                                        ...
                                        <span class="text-[13px] font-Figtree text-color-89 font-medium mt-2 sm:hidden block break-words">{{ $audio->name . ' ' . '(' . $audio->gender . ')' }}</span>
                                    </td>
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="absolute ltr:right-0 rtl:left-0 mt-2 w-[201px] border border-color-89 dark:border-color-47 rounded-lg bg-white dark:bg-[#333332] z-50 table-drop-body dropdown-shadow">
                                                    <div class="my-2">
                                                        ...
                                                        <a href="{{ $audio->googleAudioUrl() }}" download="{{ cleanedUrl(trimWords($audio->title, 30, '')) }}" class="file-need-download flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 dark:hover:bg-[#3A3A39] rounded-t-none rounded-b-lg text-left">
                                                            <span class="w-4 h-4">
                                                                <svg  class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        <p class="text-center font-medium text-color-89 text-15 px-5 font-Figtree mt-3 md:w-[450px] mx-auto">{{ __('Looks like you did not clone any voices yet.')}}</p>
                                        <a
                                        class="magic-bg w-max rounded-xl text-16 text-white font-semibold py-3 px-6 mx-auto flex text-center my-10 cursor-pointer" href="{{ route('user.voiceClone.template') }}">
                                            <span>
                                                {{ __('Clone your own Voice') }}
                                            </span>
                                        </a>
                                    </td>
                                </tr>
