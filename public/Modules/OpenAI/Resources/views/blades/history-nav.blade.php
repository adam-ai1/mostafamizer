...
<div class="border-b dark:border-[#474746] dark:bg-[#292929] bg-white 9xl:px-[185px] 7xl:px-[140px] sm:px-5 whitespace-nowrap w-full ">
    <div class="flex overflow-auto">
        @if(hasAccess('template') && customerPanelAccess('template') || isset($currentPackage))
        ...
        <!-- Long Article -->
        @if( (hasAccess('long_article') && customerPanelAccess('long_article')) || isset($currentPackage))
        ...
        @if( (hasAccess('code') && customerPanelAccess('code')) || isset($currentPackage))
        ...
        @if( (hasAccess('speech_to_text') && customerPanelAccess('speech_to_text')) || isset($currentPackage))
        ...
        @if( (hasAccess('voiceover') && customerPanelAccess('voiceover')) || isset($currentPackage))
        ...
        <a href="{{ route('user.podcast.index') }}">
            <div class="relative {{ $menu == 'podcast' ? 'active-border text-color-14 dark:text-white' : 'text-color-89' }} flex gap-2.5 items-center px-5 py-[14px]">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-color-14 dark:text-white text-15 font-FigTree font-medium">{{ __('AI Duo Podcast') }}</p>
            </div>
        </a>

        @if( (hasAccess('voice_clone') && customerPanelAccess('voice_clone')) || isset($currentPackage))
