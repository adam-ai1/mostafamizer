                ...
                <div class="col-lg-9 col-12 ps-0">
                    <div class="card card-info shadow-none mb-0">
                        ...
                        <div class="card-body">
                            ...
                            @if(in_array($featureName, ['texttovideo','videomaker']))
                            <div class="position-relative mb-4">
                                <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); border-left: 4px solid #ffc107 !important;">
                                    <div class="card-body p-4">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="card-title mb-1 fw-bold text-dark">
                                                    <i class="fas fa-exclamation-triangle text-warning me-2"></i>
                                                    {{ __('Video Processing Setup Required') }}
                                                </h6>
                                                <p class="card-text small mb-0 text-muted">
                                                    {{ __('Configure cron job on your server to enable video generation. Without this setup, videos will not generate.') }}
                                                </p>
                                            </div>
                                            <div class="col-auto">
                                                <a href="https://docs.artifism.techvill.net/others/cron-setup-video/"
                                                   target="_blank"
                                                   class="btn btn-warning btn-sm fw-semibold px-3 py-2 shadow-sm">
