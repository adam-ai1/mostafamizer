...
@section('page_title', __('Ai Chatbot'))
...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="ai-chatbot-list-container">
    <div class="card">
        <div class="card-header bb-none pb-0 mb-2">
            <h5>{{ __('AI Chatbots') }}</h5>
...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\v2\AiChatbotController@pdf', $prms) ? '1' : '0' }}";
    var csv = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\v2\AiChatbotController@csv', $prms) ? '1' : '0' }}";
    var listContainer = "ai-chatbot-list-container";
    var endRoute = "/ai-chatbot/";
</script>
