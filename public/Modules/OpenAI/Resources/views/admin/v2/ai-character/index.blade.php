...
@section('page_title', __('Avatar Lists'))
...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="avatar-list-container">
    <div class="card">
        <div class="card-header bb-none pb-0 mb-2">
            <h5>{{ __('Avatar Lists') }}</h5>
        ...
        <x-backend.datatable.table-wrapper class="user-list-wallet user-list-processing-message"
            data-namespace="\Modules\OpenAI\Entities\Avatar" data-column="id">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-dark">
                        <h5 class="modal-title text-white">{{ __('Sync :x', ['x' => __('Avatars')]) }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        @if ( count($providers) != 0 )
                            <form id="sync-data-form">
                                <input type="hidden" name="type" id="type" value="avatars">
...
<script type="text/javascript">
    'use strict';
    var listContainer = "avatar-list-container";
    var endRoute = "/ai-character/avatars/";
