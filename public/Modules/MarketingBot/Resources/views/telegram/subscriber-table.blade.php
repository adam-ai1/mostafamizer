<div class="subscriber-table table-content{{ isset($is_ajax) && $is_ajax ? '' : ' hidden' }}">
    <!-- Table -->
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody
                    ...
                    @forelse ( $subscribers as $subcriber )
                        <tr id="subscriber-row-{{ $subcriber->id }}"
                            ...
                            <td class="px-6 py-3 text-color-14 dark:text-white">
                               {{ $subcriber->name }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7">
                                ...
                                <p class="text-color-14 dark:text-white text-center font-medium font-Figtree text-20 mt-6">{{ __('No subscribers found')}}</p>
                                <p class="text-center font-medium text-color-89 text-15 px-5 py-3 font-Figtree mt-3 md:w-[450px] mx-auto">{{ __('Looks like you did not add any subscribers yet.')}}</p>
                            </td>
                        </tr>
                    @endforelse
                        ...
                        >
                            <div class="px-7">
                                ...
                                <div class="flex justify-center gap-3 mt-6">
                                    <button
                                        class="delete-subscriber w-full flex items-center justify-center rounded-[6px] text-sm text-center magic-bg hover:shadow-lg text-white px-5 py-2.5 font-medium hover:opacity-90 transition-all duration-200"
                                    >
                                        <span>{{ __('Delete') }}</span>
    ...
    <!-- Pagination -->
    {{ $subscribers->onEachSide(1)->links('site.layout.partials.pagination') }}
