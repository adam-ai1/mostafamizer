// Contacts Skeleton Loading Functions
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Watch for when contacts table content is loaded
    const elementsToWatch = ['#contacts-table-container'];
    let loadedCount = 0;
