                                            ...
                                            @if ($loop->first && count($supportedFeatures) > 0)
                                                <div class="flex items-center gap-1.5">
                                                    ...
                                                    <div class="relative group">
                                                        ...
                                                        <div class="absolute left-1/2 -translate-x-1/2 mt-2 w-64 bg-white border border-gray-200 rounded-xl shadow-2xl z-50
                                                                        opacity-0 group-hover:opacity-100 transition-opacity duration-200
                                                                        max-h-56 overflow-y-auto pointer-events-auto p-4 flex flex-col gap-2">
                                                            <div class="mb-3">
