        ...
        if(empty($page)) {
            ...
            \DB::table('component_properties')->upsert(array (
                ...
                array (
                    ...
                    'name' => 'body',
                    'type' => 'string',
                    'value' => 'voxcraft Studio is the ultimate AI-powered content-generating tool to help you quickly create high-quality content that requires minimal effort, time, and cost.',
                ),
                37 => 
                array (
                    'component_id' => 2,
                ...
                array (
                    ...
                    'name' => 'block3_body',
                    'type' => 'string',
                    'value' => 'Intuitive interface and minimal learning curve make voxcraft Studio the ideal choice for anyone who needs to write content quickly without sacrificing quality and reach your milestones 10X faster!',
                ),
                72 => 
                array (
                    'component_id' => 2,
                    ...
                    'type' => 'string',
                    'value' => ' voxcraft Studio is built to focus and create human-like content that helps you generate engaging content and ideas for blogs, applications, social media, videos, digital art, SEO, and much more.',
                ),
                73 => 
                array (
                    'component_id' => 2,
                ...
                array (
                    ...
                    'name' => 'body',
                    'type' => 'string',
                    'value' => ' Thousands of marketers, agencies, and entrepreneurs choose voxcraft Studio to automate and simplify their content marketing.',
                ),
                186 => 
                array (
                    'component_id' => 5,
                ...
                array (
                    ...
                    'name' => 'body',
                    'type' => 'string',
                    'value' => ' See what other people are saying about voxcraft Studio and be a part of it.',
                ),
                234 => 
                array (
                    'component_id' => 7,
                ...
                array (
                    ...
                    'name' => 'body',
                    'type' => 'string',
                    'value' => ' See what other people are asking about voxcraft Studio and be a part of it.',
                ),
                248 => 
                array (
                    'component_id' => 8,
                ...
                array (
                    ...
                    'name' => 'body',
                    'type' => 'string',
                    'value' => 'Explore voxcraft Studio for free to see the potential and how it can help to autopilot the content creation process.',
                ),
                284 => 
                array (
                    'component_id' => 10,
