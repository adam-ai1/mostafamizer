...
namespace Modules\AiInfluencer\Responses\AiShorts\Klap;
...
class VideoResponse implements VideoResponseContract
{
    ...
    public function process()
    {
        if ($this->response['code'] == 401) {
            return $this->handleException(__("There's an issue with the :x API key. Kindly reach out to the administration for assistance.", ['x' => 'Klap']));
        }
    ...
    {
        return $this->videoId = $this->response['body']['output_id'];
    }
