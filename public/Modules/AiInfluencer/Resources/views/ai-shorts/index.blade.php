...
@section('page_title', __('Ai Shorts'))
@section('content')
    {{-- main content --}}
    <div
        ...
        <div
            ...
            <div class="xl:w-[401px] 5xl:w-[474px] pt-14">
                @include('aiinfluencer::ai-shorts.form')
            </div>
...
@section('js')
    ...
    <script src="{{ asset('Modules/AiInfluencer/Resources/assets/js/ai_shorts/script.min.js') }}"></script>
@endsection
