...
@section('page_title', __('Url to Video'))
@section('content')
    {{-- main content --}}
    <div
        ...
        <div
            ...
            <div class="xl:w-[401px] 5xl:w-[474px] pt-14">
                @include('aiinfluencer::url-to-video.form')
            </div>
...
@section('js')
    ...
    <script src="{{ asset('Modules/AiInfluencer/Resources/assets/js/url-to-video/script.min.js') }}"></script>
@endsection
