...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleFiles(files) {
        ...
        if (validFiles.length === 0) {
            displayError(jsLang("Invalid file type. Only mp4, webm, ogg,  avi, mov, wmv, flv, mkv are allowed."));
            return;
        }
...
$(document).on('submit', '#urltovideo-form', function (e) {
    e.preventDefault();
    ...
    $.ajax({
        ...
        beforeSend: function (xhr) {
            ...
            $('#urltovideo-creation').attr('disabled', 'disabled');
        ...
        success: function(response) {
            if (response.message) {
                errorMessage(response.message, 'urltovideo-creation');
                return true;
            }

            $("#urltovideo-form .loader").addClass('hidden');
            
            $(".loader").addClass('hidden');
            $('#urltovideo-creation').removeAttr('disabled');
            ...
            $('#urltovideo-gallery').prepend(video);
            ...
            const newVideos = $('#urltovideo-gallery .cursor-pointer')
        ...
        error: function(response) {
            ...
            try {
                ...
                errorMessage(jsLang('Invalid server response'), 'urltovideo-creation');
                return true;
            }
            ...
            if (message) {
                errorMessage(message, 'urltovideo-creation');
                return true;
            }
        }
...
function initializeCustomVideoPlayer(videos) {
    videos.forEach(video => {
        ...
        const gallery = document.getElementById('urltovideo-gallery');
