...
class SystemUpdateController extends Controller
{
    ...
    public function upgrade(Request $request)
    {
        if ($request->isMethod('get')) {
            ...
            $data['applicationVersion']  = config('artifism.file_version', env('VOXCRAFT_STUDIO_VERSION', '1.0.0'));
    ...
    public function checkVersion()
    {
        ...
        $version = config('artifism.file_version', env('VOXCRAFT_STUDIO_VERSION', '1.0.0'));
