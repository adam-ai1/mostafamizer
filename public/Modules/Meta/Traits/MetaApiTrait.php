...
trait MetaApiTrait
{
    ...
    {
        $key = config("aiKeys.META.API_KEY");
    ...
    {
        return $this->makeCurlRequest(moduleConfig('meta.base_url') . 'v1/chat/completions', "POST", json_encode($this->processedData));
    }
    ...
    public function chatStream()
    {
        ...
        try {
            ...
            $response = $client->request('POST', moduleConfig('meta.base_url') . 'v1/chat/completions', [
