...
$(document).ready(function() {
    function toggleBypassUrl() {
        if ($('#maintainance-mode').val() === 'true') {
            $('#bypass-url').slideDown();
        } else {
            $('#bypass-url').slideUp();
        }
    }
    ...
    // Attach change event listener to the maintenance mode select
    $('#maintainance-mode').on('change', toggleBypassUrl);
});
