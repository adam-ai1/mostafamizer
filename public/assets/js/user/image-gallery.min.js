"use strict";const progressBar=document.getElementById("progress-input");function copyToClipboard(a,b){var c=$(b).text();navigator.clipboard.writeText(c).then(function(){$(a).addClass("clicked"),$(a).find("span.copy-data").addClass("hidden"),setTimeout(function(){$(a).removeClass("clicked"),$(a).find("span.copy-data").removeClass("hidden")},3e3)})}function downloadAll(){var a=document.querySelectorAll(".variant-images img");a.forEach(function(a){const b=a.getAttribute("data-original"),c=a.getAttribute("download");downloadImage(b,c)})}function downloadImage(a,b){const c=document.createElement("a");c.href=a,c.download=b,c.click()}$(".modal-not-open").on("click",function(){$(".image-information-modal").css("display","none")});function clipboard(a,b){a.prev("input[type=\"text\"]").focus().select(),document.execCommand(b),a.prev("input[type=\"text\"]").blur(),a.addClass("clicked"),$(".copy-link").addClass("hidden"),setTimeout(function(){a.removeClass("clicked"),$(".copy-link").removeClass("hidden")},3e3)}$(document).on("click",".image-modal-button",function(){setAttribute($(this)),fetchImageData($(this).data("slug"))});function setAttribute(a){$(".favorite-icon").remove();$(".favorite-modal-image-");$(this).hasClass(".favorite-modal-image-"+a.data("id"))||$(".favorite-modal").addClass("favorite-modal-image-"+a.data("id")),$(".image-information-modal").css("display","flex"),$(".gallery-placeholder").hide(),$(".main-image").attr("src",a.data("source")),$(".image-promt").text(a.data("promt")),$(".image-title").text(a.data("name")),$(".image-style").text(a.data("style")),$(".lighting-style").text(a.data("lightstyle")),$(".image-resulation").text(a.data("resulation")),$(".image-created").text(a.data("created")),$(".modal-image-delete").attr("id",a.data("id")),$(".share-image").attr("src",a.data("source")),$(".facebook-image-share").attr("href","https://www.facebook.com/sharer.php?u="+encodeURIComponent(a.data("source"))),$(".linkedin-image-share").attr("href","http://www.linkedin.com/shareArticle?mini=true&url="+encodeURIComponent(a.data("source"))),$(".instagram-image-share").attr("href","https://www.instagram.com/sharer.php?u="+encodeURIComponent(a.data("source"))),$(".whatsapp-image-share").attr("href","https://api.whatsapp.com/send?text="+encodeURIComponent(a.data("source"))),$(".pinterest-image-share").attr("href","http://pinterest.com/pin/create/button/?url="+encodeURIComponent(a.data("source"))),$(".delete-image-bg").attr("href",a.data("source"));var b=SITE_URL+"/user/image";$(".varient-url").attr("href",b+"?prompt="+a.data("name")),$(".favorite-modal").attr("data-image-id",a.data("id")),$(".modal-image-delete").attr("image-id",a.data("id")),$(".image-share-text-box").val(SITE_URL+"/image-share/"+a.data("slug"));var c=$(".favorite-image-"+a.data("id")).attr("data-is-favorite");if(!0===c||"true"==c)var d=`<div class="favorite-icon relative md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg bg-white wishlist-border">
        ...
        </div>`;else var d=`<div class="favorite-icon relative md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47">
        ...
        </div>`;$(".favorite-modal").html(d),$(".favorite-modal").html(`  
    ...
    `)}$(document).on("click",".related-image-modal",function(){swiper.destroy(),swiper2.destroy(),setAttribute($(this)),fetchImageData($(this).data("slug"))});function fetchImageData(a){var b="",c="";$(".old-img").hide(),$(".releted-image-body").show(),$.ajax({url:SITE_URL+"/user/image-view/"+a,type:"get",dataType:"json",beforeSend:function(){$(".varient-image").append("\n                <div class=\"flex justify-center gap-3\">\n                    <div class=\"skeleton-loader !w-[80px] h-[68px] dark:bg-color-89 mb-3 relative px-[14px] lg:px-5 py-[14px] lg:py-4 rounded-xl\">\n                        \n                    </div>\n                    <div class=\"skeleton-loader !w-[80px] h-[68px] dark:bg-color-89 mb-3 relative px-[14px] lg:px-5 py-[14px] lg:py-4 rounded-xl\">\n                        \n                    </div>\n                    <div class=\"skeleton-loader !w-[80px] h-[68px] dark:bg-color-89 mb-3 relative px-[14px] lg:px-5 py-[14px] lg:py-4 rounded-xl\">\n                        \n                    </div>\n                </div>"),$(".releted-image").append(`
                ...
                </div>`)},success:function(a){a.data.variants.length&&(a.data.variants.forEach(function(a){b+=`<div class="swiper-slide cursor-grab !w-[80px] h-full rounded-lg old-img variant-images">
                                        <img class="mx-auto w-[68px] h-[68px] rounded-[10px] object-cover" data-original="${a.originalImageUrl}" src="${a.imageUrl}" download="" />
                                    </div>`}),$(".varient-image").empty(),$(".varient-image").append(b),a.data.relatedImages.forEach(function(a){c+=`<img src="${a.imageUrl}" data-slug="${a.slug}" data-name="${a.name}" data-promt="${a.promt}" data-id="${a.id}" data-style="${a.art_style}" data-resulation="${a.size}" data-created="${a.created_at}" data-lightstyle="${a.lighting_style}" data-source="${a.imageUrl}" id=${a.id} data-slug="${a.slug}" class="old-img cursor-pointer related-image-modal xl:w-[252px] xl:h-[252px] lg:w-[206px] lg:h-[206px] md:w-[156px] md:h-[156px] xs:w-[174px] xs:h-[174px] w-[140px] h-[140px] rounded-lg object-cover">`}),$(".releted-image").empty(),""===$.trim(c)?$(".releted-image-body").hide():$(".releted-image").append(c),$(".main-image-varient").html(a.html)),$(".loader-template").remove(),gallerySlider(),shareModal(),$(".copy-btn").on("click",function(){clipboard($(this),"copy")}),swiper2.on("slideChange",function(){var a=swiper2.activeIndex;$(".modal-image-delete").attr("id",$(".swiper-slide").eq(a).attr("id"))})}})}$(document).on("click",".modal-close-btn",function(){$(".varient-image").val(),$(".releted-image").val(),$(".main-image-varient").val(),$(".image-information-modal").css("display","none"),$(".favorite-modal").html(`  
    <div class="loader-template md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47">
        <svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
            <mask id="path-1-inside-1_1032_3036" fill="white">
                <path d="M67 36C69.7614 36 72.0357 38.2493 71.6534 40.9841C70.685 47.9121 67.7119 54.4473 63.048 59.7573C57.2779 66.3265 49.3144 70.5713 40.644 71.6992C31.9736 72.8271 23.1891 70.761 15.9304 65.8866C8.67173 61.0123 3.4351 53.6628 1.19814 45.2104C-1.03881 36.7579 -0.123172 27.7803 3.77411 19.9534C7.67139 12.1266 14.2839 5.98568 22.3772 2.67706C30.4704 -0.631565 39.4912 -0.881694 47.7554 1.97337C54.4353 4.28114 60.2519 8.49021 64.5205 14.0322C66.2056 16.2199 65.3417 19.2997 62.9417 20.6656L60.8567 21.8524C58.4567 23.2183 55.4379 22.3325 53.5977 20.2735C50.9338 17.2927 47.5367 15.0161 43.7066 13.6929C38.2888 11.8211 32.3749 11.9851 27.0692 14.1542C21.7634 16.3232 17.4284 20.3491 14.8734 25.4802C12.3184 30.6113 11.7181 36.4969 13.1846 42.0381C14.6511 47.5794 18.0842 52.3975 22.8428 55.5931C27.6014 58.7886 33.3604 60.1431 39.0445 59.4037C44.7286 58.6642 49.9494 55.8814 53.7321 51.5748C56.4062 48.5302 58.2325 44.8712 59.0732 40.9628C59.6539 38.2632 61.8394 36 64.6008 36H67Z" />
    ...
    `)});function shareModal(){$(".share-information").on("click",function(){$(".share-information-modal").css("display","flex"),$(".image-modal-container").show()}),$(".share-modal-close-btn").on("click",function(){$(".share-information-modal").css("display","none")})}let swiper,swiper2;function gallerySlider(){swiper=new Swiper(".gallery-slider",{slidesPerView:4,roundLengths:!0,loopAdditionalSlides:30,observer:!0,observeParents:!0,observeChildren:!0,freeMode:!0,watchSlidesProgress:!0,breakpoints:{428:{slidesPerView:5},640:{slidesPerView:6},800:{slidesPerView:5},1152:{slidesPerView:6}}}),swiper2=new Swiper(".gallery-slider2",{spaceBetween:0,effect:"fade",thumbs:{swiper:swiper}})}const gallery=document.getElementById("gallery");if(progressBar){function a(){const a=(100*((d-b)/(c-b))).toFixed(2);progressBar.style.background=`linear-gradient(to right, #898989 0%, #898989 ${a}%, #DFDFDF ${a}%, #DFDFDF 100%)`}progressBar.addEventListener("input",function(){const a=parseInt(progressBar.value),b=3,c=Math.round(b+a/100*(8-b));gallery.style.setProperty("--num-columns",c)});const b=parseFloat(progressBar.min),c=parseFloat(progressBar.max);let d=parseFloat(progressBar.value);a(),progressBar.oninput=function(){d=parseFloat(this.value),a()}}function imageToggle(a){var b=a.getAttribute("data-image-id"),c=a.getAttribute("data-is-favorite")+"";toggleImage(b,"true"!=c,a)}function toggleImage(a,b,c){$.ajax({url:imageToggleFavoriteUrl,type:"POST",dataType:"json",data:{_token:CSRF_TOKEN,image_id:a,toggle_state:b+""},beforeSend:()=>{$(c).html(`  
            <div class="loader-template md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47">
                <svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                    <mask id="path-1-inside-1_1032_3036" fill="white">
                        <path d="M67 36C69.7614 36 72.0357 38.2493 71.6534 40.9841C70.685 47.9121 67.7119 54.4473 63.048 59.7573C57.2779 66.3265 49.3144 70.5713 40.644 71.6992C31.9736 72.8271 23.1891 70.761 15.9304 65.8866C8.67173 61.0123 3.4351 53.6628 1.19814 45.2104C-1.03881 36.7579 -0.123172 27.7803 3.77411 19.9534C7.67139 12.1266 14.2839 5.98568 22.3772 2.67706C30.4704 -0.631565 39.4912 -0.881694 47.7554 1.97337C54.4353 4.28114 60.2519 8.49021 64.5205 14.0322C66.2056 16.2199 65.3417 19.2997 62.9417 20.6656L60.8567 21.8524C58.4567 23.2183 55.4379 22.3325 53.5977 20.2735C50.9338 17.2927 47.5367 15.0161 43.7066 13.6929C38.2888 11.8211 32.3749 11.9851 27.0692 14.1542C21.7634 16.3232 17.4284 20.3491 14.8734 25.4802C12.3184 30.6113 11.7181 36.4969 13.1846 42.0381C14.6511 47.5794 18.0842 52.3975 22.8428 55.5931C27.6014 58.7886 33.3604 60.1431 39.0445 59.4037C44.7286 58.6642 49.9494 55.8814 53.7321 51.5748C56.4062 48.5302 58.2325 44.8712 59.0732 40.9628C59.6539 38.2632 61.8394 36 64.6008 36H67Z" />
            ...
            `)},success:function(d){b?$(c).html(`
                ...
                </div>`),$(".favorite-image-"+a).each((a,c)=>{let d=b?"true":"false";c.setAttribute("data-is-favorite",d),b?$(c).closest(".gallery-item").removeClass("non-favorite").addClass("favorite"):($(c).closest(".gallery-item").removeClass("favorite").addClass("non-favorite"),"all"==$("#favorite-image-filter").attr("data-text")&&$(".non-favorite").hide())}),toastMixin.fire({title:d.message,icon:"success"})},error:function(){toastMixin.fire({title:response.message,icon:"error"})},complete:()=>{$(".loader-template").remove()}})}function setFavorite(a){$("#favorite-image-filter").attr("data-text","all"),$(".non-favorite").hide(),$(a).html(`<svg width="17" height="17" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                `)}function setNotFavorite(a){$("#favorite-image-filter").attr("data-text","favorite"),$(".non-favorite").show(),$(a).html(`
    ...
    <p class="dark:text-white text-color-14 font-semibold mt-1">${jsLang("Favorites")}</p>
    `)}$("#favorite-image-filter").on("click",function(){"all"==$("#favorite-image-filter").attr("data-text")?setNotFavorite(this):setFavorite(this)});function modalImageToggle(a){var b=a.getAttribute("data-image-id"),c=a.getAttribute("data-is-favorite")+"";toggleModalImage(b,"true"!=c,a)}function toggleModalImage(a,b,c){$.ajax({url:imageToggleFavoriteUrl,type:"POST",dataType:"json",data:{_token:CSRF_TOKEN,image_id:a,toggle_state:b+""},beforeSend:()=>{$(c).html(`
            <div class="loader-template md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47">
                <svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                    <mask id="path-1-inside-1_1032_3036" fill="white">
                        <path d="M67 36C69.7614 36 72.0357 38.2493 71.6534 40.9841C70.685 47.9121 67.7119 54.4473 63.048 59.7573C57.2779 66.3265 49.3144 70.5713 40.644 71.6992C31.9736 72.8271 23.1891 70.761 15.9304 65.8866C8.67173 61.0123 3.4351 53.6628 1.19814 45.2104C-1.03881 36.7579 -0.123172 27.7803 3.77411 19.9534C7.67139 12.1266 14.2839 5.98568 22.3772 2.67706C30.4704 -0.631565 39.4912 -0.881694 47.7554 1.97337C54.4353 4.28114 60.2519 8.49021 64.5205 14.0322C66.2056 16.2199 65.3417 19.2997 62.9417 20.6656L60.8567 21.8524C58.4567 23.2183 55.4379 22.3325 53.5977 20.2735C50.9338 17.2927 47.5367 15.0161 43.7066 13.6929C38.2888 11.8211 32.3749 11.9851 27.0692 14.1542C21.7634 16.3232 17.4284 20.3491 14.8734 25.4802C12.3184 30.6113 11.7181 36.4969 13.1846 42.0381C14.6511 47.5794 18.0842 52.3975 22.8428 55.5931C27.6014 58.7886 33.3604 60.1431 39.0445 59.4037C44.7286 58.6642 49.9494 55.8814 53.7321 51.5748C56.4062 48.5302 58.2325 44.8712 59.0732 40.9628C59.6539 38.2632 61.8394 36 64.6008 36H67Z" />
            ...
            `)},success:function(){b?($(c).html(`
                <div class="relative tooltips md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg bg-white wishlist-border">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 4.5L6.5 3L3.5 4L2.5 6V8.5L9 15L9.5 14.5L12 11.5L14.5 9.5L15.5 7.5L14.5 4.5L11.5 3L9 4.5Z" fill="#E22861"/>
                        <path d="M9.00077 3.39692C9.85769 2.62982 10.9759 2.22007 12.1256 2.25187C13.2752 2.28368 14.3691 2.75462 15.1823 3.56792C15.9948 4.38031 16.4658 5.47273 16.4987 6.62123C16.5316 7.76974 16.1239 8.88733 15.3593 9.74492L8.99927 16.1139L2.64077 9.74492C1.87521 8.88689 1.46717 7.76834 1.50042 6.61891C1.53367 5.46948 2.00569 4.37638 2.81956 3.56404C3.63344 2.7517 4.72742 2.28175 5.87691 2.25067C7.02641 2.21959 8.14419 2.62974 9.00077 3.39692ZM14.1203 4.62767C13.5785 4.08626 12.85 3.77273 12.0843 3.75139C11.3187 3.73005 10.5739 4.00253 10.0028 4.51292L9.00152 5.41142L7.99952 4.51367C7.43077 4.00509 6.68961 3.73232 5.92687 3.75086C5.16412 3.7694 4.43709 4.07787 3.89373 4.61349C3.35037 5.14911 3.03151 5.87163 3.00202 6.63404C2.97254 7.39644 3.23465 8.14143 3.73502 8.71742L9.00002 13.9907L14.265 8.71817C14.7633 8.14472 15.0254 7.4036 14.9986 6.6444C14.9717 5.8852 14.6578 5.16446 14.1203 4.62767Z" fill="#E22861"/>
                    </svg> 
                </div>`),$(".favorite-image-"+a).html(`
                <div class="relative tooltips md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg bg-white wishlist-border">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 4.5L6.5 3L3.5 4L2.5 6V8.5L9 15L9.5 14.5L12 11.5L14.5 9.5L15.5 7.5L14.5 4.5L11.5 3L9 4.5Z" fill="#E22861"/>
                        <path d="M9.00077 3.39692C9.85769 2.62982 10.9759 2.22007 12.1256 2.25187C13.2752 2.28368 14.3691 2.75462 15.1823 3.56792C15.9948 4.38031 16.4658 5.47273 16.4987 6.62123C16.5316 7.76974 16.1239 8.88733 15.3593 9.74492L8.99927 16.1139L2.64077 9.74492C1.87521 8.88689 1.46717 7.76834 1.50042 6.61891C1.53367 5.46948 2.00569 4.37638 2.81956 3.56404C3.63344 2.7517 4.72742 2.28175 5.87691 2.25067C7.02641 2.21959 8.14419 2.62974 9.00077 3.39692ZM14.1203 4.62767C13.5785 4.08626 12.85 3.77273 12.0843 3.75139C11.3187 3.73005 10.5739 4.00253 10.0028 4.51292L9.00152 5.41142L7.99952 4.51367C7.43077 4.00509 6.68961 3.73232 5.92687 3.75086C5.16412 3.7694 4.43709 4.07787 3.89373 4.61349C3.35037 5.14911 3.03151 5.87163 3.00202 6.63404C2.97254 7.39644 3.23465 8.14143 3.73502 8.71742L9.00002 13.9907L14.265 8.71817C14.7633 8.14472 15.0254 7.4036 14.9986 6.6444C14.9717 5.8852 14.6578 5.16446 14.1203 4.62767Z" fill="#E22861"/>
                ...
                </div>`));let d=b?"true":"false";$(".favorite-modal-image-"+a+", .favorite-image-"+a).attr("data-is-favorite",d),b?$("#image_"+a).removeClass("non-favorite").addClass("favorite"):($("#image_"+a).removeClass("favorite").addClass("non-favorite"),"all"==$("#favorite-image-filter").attr("data-text")&&$(".non-favorite").hide())}})}function filter(a){const b=a.value;sortDivs(b)}function sortDivs(c){const d=document.querySelector(".gallery"),e=Array.from(d.querySelectorAll(".gallery-item"));e.sort((d,a)=>{const b=parseInt(d.id.split("_")[1]),e=parseInt(a.id.split("_")[1]);return"newest"===c?e-b:b-e});for(const a of e)d.appendChild(a)}$(document).ready(function(){if(window.location.href.includes("?slug")){var a=window.location.href.split("?slug=");if(1<a.length){var b=decodeURIComponent(a[1]),c=$(".image-modal-button[data-slug=\""+b+"\"]");0<c.length&&c.trigger("click")}}});var galleryPageNumber=$("#gallery").data("next-page-url")?$("#gallery").data("next-page-url").split("?page=")[1]:0,galleryChecked=!0;$(".gallery-scrollbar").on("scroll",function(){checkGalleryImageIfAtEnd(this)});var spinner=`
...
`;function checkGalleryImageIfAtEnd(a){var b=a.scrollHeight,c=a.clientHeight,d=a.scrollTop;if(d+c>=b&&0!=galleryPageNumber&&0!=galleryPageNumber.length&&galleryChecked){galleryChecked=!1;const a=$("#gallery");a.append(spinner),doAjaxprocess(SITE_URL+"/user/image-gallery?page="+galleryPageNumber,{},"get","json").done(function(b){var c=b.items.map(function(a){return`
                <div class="gallery-item overflow-hidden md:rounded-lg rounded h-max cursor-pointer ${a.is_favorite?"favorite":"non-favorite"}" id="image_${a.id}">
                    <div class="img-content bg-white img-grow md:rounded-lg rounded relative download-gallery-image-container download-image-container">
                        <div class="tab-content-${a.id}">
                            <img class="img-responsive object-cover ${a.size}" src="${a.imageUrl}">
                            <div class="gallery-image-hover-overlay image-modal-button" id=${a.id} data-slug="${a.slug}" data-name="${a.name}" data-promt="${a.promt}" data-id="${a.id}" data-style="${a.art_style}" data-resulation="${a.size}" data-created="${a.created_at}" data-lightstyle="${a.lighting_style}" data-source="${a.imageUrl}" data-is-favorite="${a.is_favorite}"></div>
                            <div class="absolute top-0">
                                <div class="image-download-button  mt-3 md:ml-3 ml-1 bg-color-14">
                                    <a href="javascript: void(0)" class="relative md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47 modal-toggle image-tooltip-delete gallery-dlt" id="${a.id}">
                            ...
                            <div class="absolute top-0 right-0">
                                <div class="flex justify-end items-center gap-2 mt-3 md:mr-3 mr-1">
                                    <div class="image-download-button delete-image-bg">
                                        <a class="file-need-download relative md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg border border-color-47 image-tooltip-download" href="${a.imageUrl}" download="${a.name}">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="image-download-button modal-not-open delete-image-bg">
                                        <a href="javascript: void(0)" class="favorite-image-${a.id}" onclick="imageToggle(this)" data-image-id="${a.id}" data-is-favorite="${a.is_favorite}">
                                            ${a.is_favorite?`
                                                <div class="relative tooltips md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg bg-white wishlist-border">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M9 4.5L6.5 3L3.5 4L2.5 6V8.5L9 15L9.5 14.5L12 11.5L14.5 9.5L15.5 7.5L14.5 4.5L11.5 3L9 4.5Z" fill="#E22861"/>
                            ...
                            <div class="image-download-button absolute bottom-3 bg-transparent image-modal-button hidden md:block">
                                <p class="mx-2.5 line-clamp-double text-white text-base font-medium font-Figtree leading-6 wrap-anywhere">${a.promt}
                                </p>
                            </div>
                        </div>
                ...
                `}).join("");$(".fetch-skeleton").hide(),a.append(c),a.removeAttr("data-next-page-url"),galleryPageNumber=b.nextPageUrl?b.nextPageUrl.split("?page=")[1]:[],galleryChecked=!0})}}$(document).on("click",".gallery-dlt",function(){$(this).append(`
